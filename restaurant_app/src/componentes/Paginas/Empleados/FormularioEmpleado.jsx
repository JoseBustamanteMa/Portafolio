...
const FormularioEmpleado = ({
  ...
  const onBlurCorreo = () => {
    ...
    const empleadosFiltrado = empleados.filter(
      (item) => item.id_empleado !== idEmpleado
    );
  ...
  const agregarEmpleado = (e) => {
    ...
    if (!correoIgualError) {
      ...
      const requestInit = {
        ...
        body: JSON.stringify({
          id_empleado: randomId,
          nom_empleado: nomEmpleado,
          nom2_empleado: nom2Empleado,
  ...
  const actualizarEmpleado = (e) => {
    ...
    if (!correoIgualError) {
      ...
      const arrayEditado = empleados.map((item) =>
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">
                  {editarEmp ? "Editar empleado" : "Agregar empleado"}
                </h4>
                <button
              ...
              <form onSubmit={editarEmp ? actualizarEmpleado : agregarEmpleado}>
                <div className="modal-body">
                  ...
                  {correoIgualError && (
                    <div
                      className="alert alert-danger mx-1 mb-0 mt-1"
                      role="alert"
                    >
